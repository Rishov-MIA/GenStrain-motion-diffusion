...
class GaussianDiffusion(nn.Module):
    ...
    def sample(self, cond=None, cond_scale=1.0, batch_size=16):
        ...
        return self.p_sample_loop(
            (batch_size, channels, num_frames, image_size, image_size), cond=[contour_cond_video, motion_cond_video], cond_scale=cond_scale
        )
    ...
    def forward(self, x, cond=None, *args, **kwargs):
        ...
        return self.p_losses(x, t, cond=[contour_cond_video, motion_cond_video], **kwargs)
...
class Trainer(object):
    ...
    def sample_and_save(
        ...
        sampled_videos = self.ema_model.sample(cond=[contour_cond_video, motion_cond_video], cond_scale=cond_scale, batch_size=num_samples)
    ...
    def sample_and_save_full_video(
        ...
        sampled_videos = self.ema_model.sample(
            cond=concatenated_video_parts, cond_scale=cond_scale, batch_size=concatenated_video_parts.shape[0]
        )
