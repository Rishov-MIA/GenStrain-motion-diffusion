...
already in the experiment's inference_disps/ folder is skipped.
    ...
    python inference.py --skip_existing
...
def pick_condition_videos_one_video_at_once(contour_cond_video_paths):
