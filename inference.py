...
def main():
    ...
    for contour_cond_video, cond_filename in tqdm(video_generator, total=total_videos, desc="videos", unit="video", position=0):
        ...
        if video_type == "cine":
            ...
            trainer.sample_and_save_one_video_at_a_time("final", contour_cond_video, cond_filename, reconstructed_disp, None, save_folder=custom_save_folder, sampler=sampler, ddim_steps=ddim_steps, ddim_eta=ddim_eta)
            ...
            reconstructed_disp = None
            trainer.sample_and_save_one_video_at_a_time("final", contour_cond_video, cond_filename, reconstructed_disp, gt_disp, save_folder=custom_save_folder, sampler=sampler, ddim_steps=ddim_steps, ddim_eta=ddim_eta)
